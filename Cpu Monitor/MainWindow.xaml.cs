...
namespace CPU_Monitor
{
    ...
    {
        public readonly static string WidgetName = "Cpu Monitor";
        public readonly static string SettingsFile = "settings.cpumonitor.json";
        private readonly Config config = new(SettingsFile);

        public CpuViewModel ViewModel { get; set; }
        private CpuViewModel.SettingsStruct Settings = CpuViewModel.Default;
